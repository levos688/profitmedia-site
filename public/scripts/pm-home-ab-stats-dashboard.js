(() => {
  ...
  const STATS_API = '/api/home-ab-stats';
  ...
  const labels = {
    ...
    sticky_cta: {
      ...
      order_system: 'הזמנת מערכת',
      start_work: 'התחלת עבודה על המערכת',
    },
    popup_delay: {
      '20s': '20 секунд',
      '25s': '25 секунд',
    ...
    bottom_copy: {
      ...
      order_system: 'הזמנת מערכת — форма внизу',
    },
    mid_cta: {
      diagnosis: 'Mid CTA: אבחון',
      order_system: 'Mid CTA: הזמנת מערכת',
    },
    offer_cta: {
      diagnosis: 'Offer block: אבחון',
      order_system: 'Offer block: הזמנת מערכת',
    },
    lead_source: {
      simple: 'Форма внизу',
      ...
      if (!contentType.includes('application/json')) {
        if (statusEl) {
          statusEl.textContent =
            'API статистики недоступен здесь (нужен Cloudflare / прод). Откройте /home/ab-stats на profitmedia.co.il с ?token=…';
        }
        return;
      }
