...
const AB_NAMESPACE: AbD1Namespace = 'home';

export const AB_EXPERIMENTS = {
  hero_copy: ['system', 'pain'],
  sticky_cta: ['diagnosis', 'order_system', 'start_work'],
  popup_delay: ['20s', '25s'],
  popup_scroll: ['50pct', '65pct'],
  bottom_copy: ['diagnosis', 'order_system'],
  mid_cta: ['diagnosis', 'order_system'],
  offer_cta: ['diagnosis', 'order_system'],
...
const STATS_KEYS: Record<AbChannel, string> = {
  all: 'pm_home_ab_stats_v1',
  fb_ads: 'pm_home_ab_stats_v1_fb',
};
